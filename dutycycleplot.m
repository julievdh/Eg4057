...
for i = 1:length(ii)-1
    ...
    % figure(11)
    % plot(maxtab(ii(i),1),ph(maxtab(ii(i),1)),'k.')
    % figure(21)
    patchline(1:length(ph(ind1:ind2)),ph(ind1:ind2),'edgecolor','k','edgealpha',0.1)
    end
end
set(gca,'Xticklabel',num2str([0 2 4 6 8 10 12 14 16]),'Xticklabel',{'0';'2';'4';'6';'8';'10';'12';'14';'16'})
xlabel('Time (s)')
