...
plot(rw015a.t(rw015a.p1(1)*fs:rw015a.p1(2)*fs),-rw015a.p(rw015a.p1(1)*fs:rw015a.p1(2)*fs),'b'); box on
plot(rw015a.t(rw015a.p2(1)*fs:rw015a.p3(2)*fs),-rw015a.p(rw015a.p2(1)*fs:rw015a.p3(2)*fs),'k'); box on
...
plot(eg047a.t(8571*fs:eg047a.p3(2)*fs),-eg047a.p(8571*fs:eg047a.p3(2)*fs),'r'); box on
...
[h4,b] = hist(eg047a.p(8571*fs:eg047a.p3(2)*fs),[0:2:31]);
h3 = h3/sum(h3);
h4 = h4/sum(h4);
